...
export default function PoweredBy(props) {
  return (
    ...
    <div className={`inline text-sm font-serif ${props.className || ''}`}>
      <span className='mr-1'> <a target="_blank" href="https://www.gov.cn/" rel="nofollow"><img style="max-width: 20px; overflow: hidden;" src="https://image.vredu.icu/img/20240825231430.png" alt="">  本站受中华人民共和国法律保护</a></span>
      <br>
  <a
