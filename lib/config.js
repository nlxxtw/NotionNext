    ...
    switch (key) {
      ...
      case 'COMMENT_WALINE_SERVER_URL':
        val =
          ...
          global.NOTION_CONFIG?.COMMENT_WALINE_SERVER_URL
        break
      case 'COMMENT_WALINE_RECENT':
        ...
        break
      case 'COMMENT_TWIKOO_ENV_ID':
        val =
          global.NOTION_CONFIG?.COMMENT_TWIKOO_ENV_ID ||
          global.NOTION_CONFIG?.TWIKOO_ENV_ID ||
          global.NOTION_CONFIG?.NEXT_PUBLIC_COMMENT_ENV_ID ||
          global.NOTION_CONFIG?.NEXT_PUBLIC_TWIKOO_ENV_ID
        break
      case 'AI_SUMMARY_API':
        val =
          global.NOTION_CONFIG?.AI_SUMMARY_API ||
          global.NOTION_CONFIG?.NEXT_PUBLIC_AI_SUMMARY_API
        break
      case 'AI_SUMMARY_KEY':
        val =
          global.NOTION_CONFIG?.AI_SUMMARY_KEY ||
          global.NOTION_CONFIG?.TianliGPT_KEY ||
          global.NOTION_CONFIG?.NEXT_PUBLIC_TIANLI_GPT_KEY
        break
      case 'AI_SUMMARY_MODEL':
        val = global.NOTION_CONFIG?.AI_SUMMARY_MODEL
        break
      case 'TianliGPT_KEY':
        val =
          global.NOTION_CONFIG?.TianliGPT_KEY ||
