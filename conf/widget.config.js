...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: 
    ...
    [
    
     {
      name: '若月亮没来（若是月亮还没来）',
      artist: '王宇宙Leto/乔浚丞',
      url: 'https://pan.19492035.xyz/raw/music/yuelanghaimei.mp3',
      cover:
    ...
    },
    {
      name: '不要慌太阳下山有月光',
      artist: '小书子',
      url: 'https://pan.19492035.xyz/raw/music/buyaohuang.mp3',
      cover:
      ...
      name: '一程山路',
      artist: '毛不易',
      url: 'https://pan.19492035.xyz/raw/music/yichengshanglu.mp3',
      cover:
        'https://p1.music.126.net/kn6ugISTonvqJh3LHLaPtQ==/599233837187278.jpg'
    }
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '19723756', // 对应歌单的 id
